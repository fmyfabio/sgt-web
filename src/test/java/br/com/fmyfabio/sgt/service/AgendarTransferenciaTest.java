...
public class AgendarTransferenciaTest {
	...
	public void taxaAgendamentoTipoBTest() throws NegocioException {
		...
		Assert.assertEquals(new Double(10.00), agendamentoAte30Dias.getTaxa());
		Assert.assertEquals(new Double(8.00), agendamentoDemais.getTaxa());
	}	
	...
	public void taxaAgendamentoTipoCTest() throws NegocioException {
		...
		Assert.assertEquals(new Double(1.2), agendamentoMaior30Dias.getTaxa());
		Assert.assertEquals(new Double(2.1), agendamentoAte30Dias.getTaxa());
		Assert.assertEquals(new Double(4.3), agendamentoAte25Dias.getTaxa());
		Assert.assertEquals(new Double(5.4), agendamentoAte20Dias.getTaxa());
		Assert.assertEquals(new Double(6.7), agendamentoAte15Dias.getTaxa());
		Assert.assertEquals(new Double(7.4), agendamentoAte10Dias.getTaxa());
		Assert.assertEquals(new Double(8.3), agendamentoAte5Dias.getTaxa());	
	}
	...
	public void taxaAgendamentoTipoDTest() throws NegocioException {
		...
		AgendamentoModel agendamentoAte100000Demais = this.criarAgendamento(this.adicionarDia( new Date() , 31), TipoAgendamento.D, 100000.00);
		// MAIOR 120000		
		...
		Assert.assertEquals(new Double(1.2), agendamentoAte25000.getTaxa());
		Assert.assertEquals(new Double(2.1), agendamentoAte10000030Dias.getTaxa());
		Assert.assertEquals(new Double(4.3), agendamentoAte100000Demais.getTaxa());
		Assert.assertEquals(new Double(5.4), agendamentoMaior120000Maior30Dias.getTaxa());
		Assert.assertEquals(new Double(6.7), agendamentoMaior120000Ate30Dias.getTaxa());
		Assert.assertEquals(new Double(7.4), agendamentoMaior120000Ate25Dias.getTaxa());
		Assert.assertEquals(new Double(8.3), agendamentoMaior120000Ate20Dias.getTaxa());		
		Assert.assertEquals(new Double(8.3), agendamentoMaior120000Ate15Dias.getTaxa());
		Assert.assertEquals(new Double(8.3), agendamentoMaior120000Ate10Dias.getTaxa());
		Assert.assertEquals(new Double(8.3), agendamentoMaior120000Ate5Dias.getTaxa());
	}	
